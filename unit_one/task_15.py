...
desc_ = ["Эта птица может летать спиной вперед", "Противовес «естественного отбора», созданный человеком", "Предмет, совершенно не интересующий свиней", "С японского это слово переводится как «Божественный ветер», однако мы привыкли к его военому толкованию"]     # Список описания слов
